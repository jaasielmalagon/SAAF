...
public class Nomina_service {
    ...
    /**
     * Regresa un objeto JTable con los datos del empleado registradas en la
     * base de datos.
     *
     * @return new JTable se usa para mostrar y editar tablas de celdas
     * bidimensionales regulares Se usará para mostrar los datos del empleado
     */
     ...
     * registrados en la base de datos. Se mostrarán el nombre,el cargo, el
     * horario de trabajo y su sueldo
     *
     * @return new DefaultComboBoxModel: Objeto que contiene los Cargos de cada
     * empleado.
     *
     */
    ...
    public DefaultComboBoxModel semanas() {
        DefaultComboBoxModel dcbm = new DefaultComboBoxModel();
        String[][] array = this.RECURSO.getSemanas();
        if (array != null) {
            dcbm.addElement(new Lista(0, "-- Seleccione --"));
            for (String[] val : array) {
                Lista l = new Lista(Integer.valueOf(val[0]), val[1]);
