 ...
 * @author JMalagon
 */
public final class asociar_direcciones extends javax.swing.JInternalFrame {
    ...
    public asociar_direcciones(Usuario usuario, String titulo, Persona cliente) {
        initComponents();
...
//        buscadorOnOff(false);
    ...
    private void domicilioActual() {
        DOMICILIO = SERVICIO.domicilio(CLIENTE.getDomicilio());
        System.out.println(DOMICILIO);
        if (DOMICILIO != null) {
            jTextArea1.setText(DOMICILIO.toString());
        } else {
            jTextArea1.setText("SIN DOMICILIO ASOCIADO ACTUALMENTE");
        }
    }

    private void llenarTabla() {
        if (DOMICILIO != null) {
            System.out.println("Sucursal: " + this.USUARIO.getIdSucursal());
            System.out.println("Domicilio: "+ DOMICILIO.getId());
            tabla.setModel(this.SERVICIO.tablaDireccionesFiltrado(this.USUARIO.getIdSucursal(), DOMICILIO.getId()));
        } else {
    ...
    private void asociarPersona(int resp, int domicilio) {
        if (resp == JOptionPane.YES_OPTION) {
            int asociado = this.SERVICIO.actualizarPersona(CLIENTE.getIdPersona(), domicilio);
            switch (asociado) {
                case 0:
                    JOptionPane.showMessageDialog(rootPane, "Domicilio asociado correctamente a " + CLIENTE.toString(), "¡Éxito!", JOptionPane.INFORMATION_MESSAGE);
                    try {
                        ...
                        System.out.println("modules_admin.agregar_direcciones.asociarPersona() : " + ex);
                        JOptionPane.showMessageDialog(rootPane, "No se pudo abrir 'Agregar personas'");
                    }
                    break;
                case 1:
                    JOptionPane.showMessageDialog(rootPane, "El domicilio seleccionado ya se encuentra asociado con 3 personas.", "¡Error!", JOptionPane.ERROR_MESSAGE);
                    break;
                default:
                    JOptionPane.showMessageDialog(rootPane, "Error al asociar el domicilio con la persona.", "¡Error!", JOptionPane.ERROR_MESSAGE);
                    break;
            }
        }
    }
    ...
    public void buscar() {
        ...
        if (DOMICILIO != null) {
            if (colonia != null && calle == null && numero == null) {
                modeloTabla = this.SERVICIO.tablaDireccionesBuscarFiltrado(this.USUARIO.getIdSucursal(), colonia.getIdColonia(), 0, 0, this.DOMICILIO.getId());
            } else if (colonia != null && calle != null && numero == null) {
                modeloTabla = this.SERVICIO.tablaDireccionesBuscarFiltrado(this.USUARIO.getIdSucursal(), colonia.getIdColonia(), calle.getIdCalle(), 0, this.DOMICILIO.getId());
            } else if (colonia != null && calle != null && numero != null) {
                modeloTabla = this.SERVICIO.tablaDireccionesBuscarFiltrado(this.USUARIO.getIdSucursal(), colonia.getIdColonia(), calle.getIdCalle(), numero.getIdNumero(), this.DOMICILIO.getId());
            } else {
                modeloTabla = this.SERVICIO.tablaDireccionesFiltrado(this.USUARIO.getIdSucursal(), DOMICILIO.getId());
            }
        }else{
        ...
        tabla.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent Mouse_evt) {
                if (Mouse_evt.getClickCount() == 1) {
                    ...
                    if (DOMICILIO != null) {
                        if (DOMICILIO.getId() == DOMICILIO_SELECCIONADO) {
                            DOMICILIO_SELECCIONADO = 0;
                            JOptionPane.showMessageDialog(rootPane, "El domicilio seleccionado ya se encuentra asociado con esta persona.", "¡Error!", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
    ...
    private void municipios() {
        ...
        comboMunicipios1.removeAllItems();
        comboMunicipios.setModel(this.SERVICIO.municipiosDeSucursal(this.USUARIO.getIdSucursal()));
        comboMunicipios1.setModel(this.SERVICIO.municipiosDeSucursal(this.USUARIO.getIdSucursal()));
    }
    ...
    private void colonias() {
        ...
        comboColonias.setModel(this.SERVICIO.cmbColonias(idMunicipio));
    }
    ...
    private void colonias1() throws SQLException {
        ...
        int idMunicipio = municipio.getIdMunicipio();              
        comboColonias1.setModel(this.SERVICIO.cmbColonias(idMunicipio));
    }

    private void calles() throws SQLException {
    ...
    private void initComponents() {
        ...
        btnAsociar = new javax.swing.JPanel();
        ...
        btnAsociar.setBackground(new java.awt.Color(255, 78, 0));
        ...
        jLabel12.setText("Agregar direccion a la persona");

        javax.swing.GroupLayout btnAsociarLayout = new javax.swing.GroupLayout(btnAsociar);
        btnAsociar.setLayout(btnAsociarLayout);
        btnAsociarLayout.setHorizontalGroup(
            btnAsociarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(btnAsociarLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(jLabel12)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        btnAsociarLayout.setVerticalGroup(
            btnAsociarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnAsociarLayout.createSequentialGroup()
        ...
        panelOpcionesLayout.setVerticalGroup(
            panelOpcionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelOpcionesLayout.createSequentialGroup()
                .addComponent(btnAsociar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        panelOpciones1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Domicilio Actual", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Solomon Sans Book", 1, 14))); // NOI18N
        panelOpciones1.setMinimumSize(new java.awt.Dimension(270, 487));

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(10);
        jTextArea1.setFont(new java.awt.Font("Solomon Sans Book", 1, 12)); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(panelOpciones, javax.swing.GroupLayout.PREFERRED_SIZE, 136, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(panelOpciones1, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(panelOpciones2, javax.swing.GroupLayout.PREFERRED_SIZE, 326, Short.MAX_VALUE))
                .addContainerGap())
        );
...
//        }
    ...
    private void btnAsociarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAsociarMouseClicked
        if (CLIENTE != null) {
            if (DOMICILIO_SELECCIONADO > 0) {
                int resp = JOptionPane.showConfirmDialog(rootPane, "¿Desea asociar domicilio a " + this.CLIENTE.toString() + "?", "Confirmación", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                asociarPersona(resp, DOMICILIO_SELECCIONADO);
            } else {
                JOptionPane.showMessageDialog(rootPane, "No ha seleccionado un domicilio de la tabla para asociar con la persona.", "¡Error!", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void comboColoniasItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboColoniasItemStateChanged
        try {
            ...
            System.out.println("modules_admin.agregar_direcciones.comboColoniasItemStateChanged() : " + ex);
        }
    ...
    private void comboMunicipios1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboMunicipios1ActionPerformed
        try {
            ...
            System.out.println("modules_admin.agregar_direcciones.comboMunicipios1ActionPerformed() : " + ex);
        }
    ...
    private javax.swing.JPanel btnAsociar;
...
//            String propietario = txtPropietario.getText();
//            String vigencia = txtAno.getText() + "-" + ((Mes) comboMeses.getSelectedItem()).getNumeroMes() + "-" + txtDia.getText();
////            if (vigencia != "00-01-0000") {
////                FILTRADO DE VIGENCIA VALIDA PARA NO METER UNA VIGENCIA MENOR A LA FECHA ACTUAL
////            }
//            int tiempoResidencia = Integer.parseInt(txtAnosResidencia.getText());
//            int encontrado = this.SERVICIO.buscarDireccion(numero);
//            if (encontrado > 0 && this.ID_DOMICILIO == 0) {
//                int resp = JOptionPane.showConfirmDialog(rootPane, "El domicilio que intenta agregar ya se encuentra registrado.\n ¿Asociar con la persona " + this.CLIENTE.toString() + "?", "¡Aviso!", JOptionPane.YES_NO_OPTION);
//                asociarPersona(resp, encontrado);
//            } else {
//                boolean gd = this.SERVICIO.guardarDatos(this.SUCURSAL, calle, numero, calle1, calle2, colonia, tipo, propietario, vigencia, tiempoResidencia);
//                if (gd == true) {
//                    JOptionPane.showMessageDialog(rootPane, "Domicilio registrado correctamente", "¡Éxito!", JOptionPane.INFORMATION_MESSAGE);
//                    domicilioActual();
//                    llenarTabla();
