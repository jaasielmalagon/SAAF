...
public class administración extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboClientes.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccione--", "Personas", "Domicilios", "Clientes" }));
...
//        try {
//            zonificacion BC = new zonificacion();
//            escritorio.add(BC);
//            BC.toFront();
//            BC.show();
//        } catch (SQLException ex) {
//            JOptionPane.showMessageDialog(rootPane, "No se pudo abrir 'Clientes'");
//        }
    ...
    private void comboCreditosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboCreditosActionPerformed
        ...
        switch (opc) {
            case 1:
                solicitudesCredito BC = new solicitudesCredito(usuario);
                escritorio.add(BC);
                Dimension FrameSize = escritorio.getSize();
                BC.setSize(FrameSize);
                BC.toFront();
